...
- [ ] #8 - Task 6: Implement Admin Question Builder and WYSIWYG Renderer *(Blocked by #4, #7)*
...
- [ ] #11 - Task 9: Implement CDI Exam Shell, Split-Resizer Pane and Part Navigator *(Blocked by #4, #10)*
- [ ] #12 - Task 10: Implement Question Renderers, Drag-and-Drop and Passage Highlighting *(Blocked by #4, #8, #11)*
...
- [ ] #15 - Task 13: Implement Dual-Channel Socket.IO Gateway & Admin Live Monitor *(Blocked by #10)*
